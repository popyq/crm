    ...
    <script type="text/javascript">
        ...
        $(function(){
            ...
            $("#chckAll").click(function () {
                // 如果"全选按钮是选中状态",则列表中的所有checkbox都选中
...
/*            $("#tBody input[type='checkbox']").click(function () {
            ...
            $("#deleteActivityBtn").click(function () {
                ...
                console.log("删除的个数"+checkkedIds.size())
                ...
                if (window.confirm("确定删除吗?")) {
                    var ids="";
                    $.each(checkkedIds,function () {  // id=xxx&id=xxx&....&id=xxx&
                        ids +="id=" +this.value+"&";
                    });
                ...
                $.ajax({
                    ...
                    success:function (data) {
                        if (data.code =="1"){
                            ...
                            alert(data.message);
                            // 模态窗口不关闭
                            $("#importActivityModel").modal("show");
                        }
                    }
                });
            });
            ...
            $.ajax({
                ...
                success:function (data) {
                    ...
                    $("#demo_pag1").bs_pagination({
                            ...
                            showRowsPerPage:true, //是否显示 "每页显示条数"部分. 默认是true---显示
