...
/**
 * @Author potato
 * @PackageName:com.bjpowernode.crm.poi
 * @Description: 使用apache-poi 生成excel文件
 * @Date 2023-04-15 0:49
 */
...
public class CreateExcelTest {
    public static void main(String[] args) throws IOException {
        ...
        // 调用工具函数生成excel文件
        OutputStream os = new FileOutputStream("D:\\Dir\\serverDir\\studentList.xls");  // 目录必须手动创建,文件如果不存在poi会自动创建
        wb.write(os);
